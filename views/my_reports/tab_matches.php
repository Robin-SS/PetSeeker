  ...
  <div class="row g-4">
    <?php foreach ($pending_matches as $m): ?>
      <?php 
        ...
        $lost_img  = get_pet_photo_url($m['lost_photo'] ?? null);
        $found_img = get_pet_photo_url($m['found_photo'] ?? null);
      ?>
      <div class="col-12">
            ...
            <div class="row align-items-center g-3 p-3 bg-light rounded">
              ...
              <div class="col-md-5">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <?php endif; ?>
                  <div>
                    <span class="badge bg-danger small mb-1">Lost Pet #<?= $m['lost_id'] ?></span>
                    <h6 class="fw-bold mb-0"><?= $m['lost_name'] ? htmlspecialchars($m['lost_name']) : 'Unnamed' ?></h6>
              ...
              <div class="col-md-5">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <?php endif; ?>
                  <div>
                    <span class="badge bg-success small mb-1">Found Pet #<?= $m['found_id'] ?></span>
                    <h6 class="fw-bold mb-0"><?= htmlspecialchars($m['found_breed']) ?></h6>
